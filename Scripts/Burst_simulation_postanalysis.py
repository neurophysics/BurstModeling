# %%
"""
Burst_simulation_postanalysis.py
Lukasz Radzinski
...
plots_output_folder = '../Results/burst_simulation_postanalysis'
...
loss_result = bm.calculate_model_loss(sigma_sim_medium_trials, is_full_output=True)

plt.suptitle('Measures composing the loss function, loss=%.3f'
